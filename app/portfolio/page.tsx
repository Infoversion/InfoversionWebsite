...
import { TreePine, Grid3X3, Cast, Smartphone, Users } from 'lucide-react'
...
const projects = [
  {
    ...
    name: 'Bazidpur',
    tagline: 'Our village. Our roots. Our family.',
    status: 'Live',
    statusColor: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
    screenshot: '/bazidpur-screenshot.png',
    problem:
      'Families with roots in Bazidpur — a historic village in Bihar, India, founded c. 1500 AD in honour of the Persian Sufi Bayazid Bastami — were losing connection with their shared heritage, ancestors, and one another, scattered across the world with no platform to reconnect.',
    solution:
      'A private, members-only iOS and Android app for the Bazidpur community. Features include Timeless Moments (curated historical photo albums), The Gallery, Memoirs (personal stories), a Reading Room, The Forum (community threads), Scattered Roots (global member map), a multi-generational Family Tree, and a dedicated section honouring Zahoor Ali — the saint of Bazidpur.',
  ...
  },
  {
    ...
    statusColor: 'bg-accent-start/10 text-accent-start border-accent-start/20',
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-20">
      ...
      <p className="text-text-secondary text-xl mb-16 max-w-2xl">
        Products live and in development. Each started with a problem that mattered.
      </p>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between flex-wrap gap-4 mb-6">
                ...
                <span className={`text-xs px-3 py-1 rounded-full border self-start ${project.statusColor}`}>
                  {project.status}
                </span>
              </div>

              {/* Screenshot + content layout for projects that have a screenshot */}
              <div className={project.screenshot ? 'flex flex-col md:flex-row gap-8 mb-8' : 'mb-8'}>
                {project.screenshot && (
